...
class libraryModel_mixedApi{
public:
    static std::shared_ptr<libraryModel_mixedApi> eInstance(std::shared_ptr<libraryModel_ecoreFactory>& factory, std::shared_ptr<libraryModel_ecorePackage>& package);
...
private:
    libraryModel_mixedApi(std::shared_ptr<libraryModel_ecoreFactory>& factory, std::shared_ptr<libraryModel_ecorePackage>& package);
