...
public:
    static std::shared_ptr<libraryModel_genericApi> eInstance(std::shared_ptr<libraryModel_ecoreFactory>& factory, std::shared_ptr<libraryModel_ecorePackage>& package, crow::SimpleApp& app);
...
private:
    libraryModel_genericApi(std::shared_ptr<libraryModel_ecoreFactory>& factory, std::shared_ptr<libraryModel_ecorePackage>& package, crow::SimpleApp& app);
